...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ADVANCED PARSER: Plucks specific Django validation rules to show the instructor
            ...
            if (djangoErrors && typeof djangoErrors === 'object') {
                const errorMessages = Object.entries(djangoErrors)
                    .map(([key, value]) => {
                        ...
                        return `${key.toUpperCase()}: ${messages}`;
                    })
                    .join(' | ');
    ...
    return (
        <div style={styles.wrapper}>
            <div style={styles.card}>
                ...
                <p style={styles.subtitle}>Initialize your workspace authority profile</p>
